        ...
        <div className="mx-auto max-w-lg px-5 pb-6 pt-4">
          ...
          <div className="mb-4 flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              <h3 className="text-safe-title text-lg font-bold">{item.word}</h3>
          ...
          <Link
            ...
            className="glow-button mt-4 inline-flex min-h-[3.25rem] w-full items-center justify-center gap-2 rounded-xl px-4 py-3 text-center text-sm font-medium text-primary-foreground"
          >
            <BookOpen size={16} />
